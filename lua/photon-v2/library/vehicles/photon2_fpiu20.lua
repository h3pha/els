...
VEHICLE.Title 		= "Truenorth Police Department - Ford Police Interceptor (2020)"
VEHICLE.Vehicle		= "20fpiu_new_sgm"
-- NOTE: "Photon 2" is a protected category!
VEHICLE.Category 	= "Photon 2: Truenorth Police Department"
VEHICLE.Author		= "HEPHA"
...
local livery = PhotonMaterial.New({
	...
	Parameters = {
		["$basetexture"] = "els/truenorth_pd/fpiu20/20_fpiu.png",
